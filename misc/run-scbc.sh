...
python -u "$BASE_DIR/rl-algos/$ALGO/main.py" --env_id "$ENV_ID" --optim_group "$TAG" --wandb_group "$WANDB_GROUP" --total_timesteps 60000 --num_steps 200 --capture_video_freq 100
EOT
    # sleep 60
done
